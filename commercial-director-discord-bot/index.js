...
const DEFAULT_CHANNEL_ID = process.env.COMMERCIAL_CHANNEL || process.env.CHANNEL_ID;
const DIRECT_CHANNEL_ID = process.env.COMMERCIAL_CHANNEL || process.env.CHANNEL_ID;
