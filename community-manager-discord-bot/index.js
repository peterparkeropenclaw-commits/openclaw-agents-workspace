...
const DEFAULT_CHANNEL_ID = process.env.COMMUNITY_CHANNEL || process.env.CHANNEL_ID;
const DIRECT_CHANNEL_ID = process.env.COMMUNITY_CHANNEL || process.env.CHANNEL_ID;
